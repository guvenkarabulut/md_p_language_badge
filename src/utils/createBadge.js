...
function createBadge(badge_slug, logo_color, border_color, bgColor) {
  ...
  const svgContent = `
      ...
      <path fill="#${bgColor}" d="M43.9353 3.39776C46.4432 1.91836 49.5568 1.91837 52.0647 3.39776L83.9019 22.1786C86.3406 23.6171 87.8372 26.2376 87.8372 29.069V66.931C87.8372 69.7624 86.3405 72.3829 83.9019 73.8214L52.0647 92.6022C49.5568 94.0816 46.4432 94.0816 43.9353 92.6022L12.0981 73.8214C9.65945 72.3829 8.16283 69.7624 8.16283 66.931V29.069C8.16283 26.2376 9.65945 23.6171 12.0981 22.1786L43.9353 3.39776Z"/>
