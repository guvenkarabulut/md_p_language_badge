...
function createBadge(badge_slug) {
  const originalSVG = getSimpleIconsBadge(badge_slug); // Bu satırı gerçek veri ile değiştirin
  var modifiedSVG;
